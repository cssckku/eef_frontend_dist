        ...
        (n._slide = function (t, n) {
          ...
          if (
            ('next' === t
              ...
              : ((i = 'carousel-item-right'), (o = 'carousel-item-prev'), (s = 'right')),
      ...
      return (
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (!o && s.toggle && 'string' == typeof n && /show|hide/.test(n) && (s.toggle = !1),
      ...
      return (
        ...
        (t._clearMenus = function (n) {
          if (!n || (3 !== n.which && ('keyup' !== n.type || 9 === n.which)))
            for (
              var i = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), o = 0, s = i.length;
              o < s;
              o++
            ) {
        ...
        (t._dataApiKeydownHandler = function (n) {
          if (
            !(/input|textarea/i.test(n.target.tagName)
              ? 32 === n.which ||
                (27 !== n.which && ((40 !== n.which && 38 !== n.which) || e(n.target).closest('.dropdown-menu').length))
              : !A.test(n.which)) &&
            !this.disabled &&
        ...
        (s._jQueryInterface = function (t) {
          return this.each(function () {
            ...
            if (
              ...
              (n || ((n = new s(this, i)), e(this).data('bs.popover', n)), 'string' == typeof t)
            ) {
  ...
  var ot = 'scrollspy',
    ...
    lt = (function () {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          if (
            'string' != typeof (t = a(a({}, rt), 'object' == typeof t && t ? t : {})).target &&
      ...
      return (
        (n.show = function () {
          ...
          if (
            ...
            if (
              (i && e(i).trigger(a), e(this._element).trigger(l), !l.isDefaultPrevented() && !a.isDefaultPrevented())
            ) {
  ...
  var ut = e.fn.toast,
    ...
    gt = (function () {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          return (
            (t = a(a(a({}, ft), e(this._element).data()), 'object' == typeof t && t ? t : {})),
...
/* jquery.nicescroll 3.6.8 InuYaksa*2015 MIT http://nicescroll.areaaperta.com */ (function (f) {
  ...
  var x = window.MutationObserver || window.WebKitMutationObserver || !1,
    ...
    R = function () {
      ...
      d.hastransform &&
        ((c[d.trstyle] = 'translate3d(1px,2px,3px)'), (d.hastranslate3d = /translate3d/.test(c[d.trstyle])));
      d.transitionstyle = !1;
      d.prefixstyle = '';
      d.transitionend = !1;
      for (
    ...
    S = function (h, c) {
      ...
      function d(b, g, u) {
        ...
        return isNaN(b)
          ? ((b = z[g] || 0),
            (u =
              3 == b ? (u ? a.win.outerHeight() - a.win.innerHeight() : a.win.outerWidth() - a.win.innerWidth()) : 1),
            a.isie8 && b && (b += 1),
            u ? b : 0)
          : b;
      }
      ...
      function t(b, g, c) {
        ...
        0 == b.deltaMode
          ...
          : 1 == b.deltaMode &&
            ((d = -Math.floor(b.deltaX * a.opt.mousescrollstep)), (e = -Math.floor(b.deltaY * a.opt.mousescrollstep)));
        g &&
          ...
          ((d = e),
          (e = 0),
          c && (0 > d ? a.getScrollLeft() >= a.page.maxw : 0 >= a.getScrollLeft()) && ((e = d), (d = 0)));
        a.isrtlmode && (d = -d);
        d &&
      ...
      if ('auto' == this.opt.rtlmode) {
        ...
        'horizontal-tb' == p || 'lr-tb' == p || '' == p
          ? ((this.isrtlmode = 'rtl' == r.css('direction')), (this.isvertical = !1))
          : ((this.isrtlmode = 'vertical-rl' == p || 'tb' == p || 'tb-rl' == p || 'rl-tb' == p),
        ...
        (this.getScrollTop = function () {
          ...
          (this.setScrollLeft = function (b) {
            return setTimeout(function () {
              if (a)
                return (
                  a.hasreversehr && (b = a.detected.ismozilla ? -(a.page.maxw - b) : a.page.maxw - b),
      ...
      this.updateScrollBar = function (b) {
        var g, c, e;
        if (a.ishwscroll)
          a.rail.css({ height: a.win.innerHeight() - (a.opt.railpadding.top + a.opt.railpadding.bottom) }),
            a.railh && a.railh.css({ width: a.win.innerWidth() - (a.opt.railpadding.left + a.opt.railpadding.right) });
        else {
          var f = a.getOffset();
          g = f.top;
          ...
          if (a.railh && !a.railslocked) {
            ...
            b = a.railh.align
              ? g + d(a.win, 'border-top-width', !0) + a.win.innerHeight() - a.railh.height
              : g + d(a.win, 'border-top-width', !0);
        ...
        a.railslocked ||
          ...
          g
            ? ((g = c ? a.doScrollLeft : a.doScrollTop),
              (d = c
                ? (b.pageX - a.railh.offset().left - a.cursorwidth / 2) * a.scrollratio.x
                : (b.pageY - a.rail.offset().top - a.cursorheight / 2) * a.scrollratio.y),
              g(d))
      ...
      this.init = function () {
        ...
        if (!a.ispage || (!e.cantouch && !e.isieold && !e.isie9mobile)) {
          ...
          a.opt.horizrailenabled &&
            ...
            n.css({ height: n.height + 'px', zIndex: a.zindex, background: a.opt.background }),
            n.append(d),
            (n.visibility = !0),
            (n.scrollable = !0),
          ...
          a.ispage
            ...
            : (a.ishwscroll
                ? ('static' == a.win.css('position') && a.css(a.win, { position: 'relative' }),
                  ...
                  a.zoom &&
                    (a.zoom.css({ position: 'absolute', top: 1, right: 0, 'margin-right': m.width + 4 }),
                    c.append(a.zoom)),
              ...
              e.isios &&
                a.css(a.win, { '-webkit-tap-highlight-color': 'rgba(0,0,0,0)', '-webkit-touch-callout': 'none' }),
          ...
          if (e.isie9mobile)
            (a.scrollmom = new M(a)),
              (a.onmangotouch = function () {
                ...
                if (0 != Math.round(Math.sqrt(Math.pow(d, 2) + Math.pow(g, 2)))) {
                  ...
                  80 < u - a.mangotouch.tm || a.mangotouch.dry != e || a.mangotouch.drx != f
                    ? (a.scrollmom.stop(),
              ...
              (m = a.getScrollTop()),
              (n = a.getScrollLeft()),
              (a.mangotouch = { sy: m, ly: m, dry: 0, sx: n, lx: n, drx: 0, lazy: !1, tm: 0 }),
            ...
            if (e.cantouch || a.istouchcapable || a.opt.touchbehavior || e.hasmstouch) {
              ...
              a.ontouchstart = function (b) {
                ...
                if (!a.railslocked) {
                  ...
                  a.opt.touchbehavior &&
                    a.isiframe &&
                    e.isie &&
                    ((g = a.win.position()), (a.rail.drag.x += g.left), (a.rail.drag.y += g.top));
                  a.hasmoving = !1;
                  a.lastmouseup = !1;
              ...
              a.ontouchend = function (b) {
                ...
                if (2 == a.rail.drag.pt) {
                  ...
                  if (
                    a.hasmoving &&
                    ((a.lastmouseup = !0), a.hideCursor(), e.hasmousecapture && document.releaseCapture(), !e.cantouch)
                  )
                    return a.cancelEvent(b);
              ...
              a.ontouchmove = function (b, c) {
                if (
                  !a.rail.drag ||
                  (b.targetTouches && a.opt.preventmultitouchscrolling && 1 < b.targetTouches.length) ||
                  (b.pointerType && 2 != b.pointerType && 'touch' != b.pointerType)
                )
                  return !1;
                if (2 == a.rail.drag.pt) {
                  ...
                  a.ishwscroll && a.opt.bouncescroll
                    ? 0 > h
                      ? (h = Math.round(h / 2))
                      : h > a.page.maxh && (h = a.page.maxh + Math.round((h - a.page.maxh) / 2))
                    : (0 > h && (u = h = 0), h > a.page.maxh && ((h = a.page.maxh), (u = 0)));
                  var l;
                  a.railh &&
                    a.railh.scrollable &&
                    ((l = a.isrtlmode ? k - a.rail.drag.sl : a.rail.drag.sl - k),
                    a.ishwscroll && a.opt.bouncescroll
                      ? 0 > l
                        ? (l = Math.round(l / 2))
                        : l > a.page.maxw && (l = a.page.maxw + Math.round((l - a.page.maxw) / 2))
                      : (0 > l && (m = l = 0), l > a.page.maxw && ((l = a.page.maxw), (m = 0))));
                  g = !1;
                  if (a.rail.drag.dl)
                    (g = !0),
                  ...
                  a.synched('touchmove', function () {
                    a.rail.drag &&
                      ...
                      a.railh && a.railh.scrollable ? (a.setScrollLeft(l), a.showCursor(h, l)) : a.showCursor(h),
                  ...
                  a.synched('mousemove', function () {
                    a.rail.drag &&
                      ...
                      a.rail.drag.hr
                        ? a.hasreversehr
                          ? a.doScrollLeft(
                              a.scrollvaluemaxw - Math.round(a.scroll.x * a.scrollratio.x),
            ...
            if (e.cantouch || a.opt.touchbehavior)
              (a.onpreventclick = function (b) {
                ...
                a.opt.grabcursorenabled &&
                  e.cursorgrabvalue &&
                  (a.css(a.ispage ? a.doc : a.win, { cursor: e.cursorgrabvalue }),
            ...
            a.opt.enablemousewheel &&
              (a.isiframe || a.mousewheel(e.isie && a.ispage ? document : a.win, a.onmousewheel),
                ...
                (a.observerremover = new x(function (b) {
                  b.forEach(function (b) {
                    if (0 < b.removedNodes.length)
                      for (var c in b.removedNodes) if (a && b.removedNodes[c] == a.win[0]) return a.remove();
                  });
                })),
      ...
      this.showCursor = function (b, c) {
        ...
        if (a.rail) {
          ...
          (a.rail.drag && 1 == a.rail.drag.pt) ||
            (void 0 !== b && !1 !== b && (a.scroll.y = Math.round((1 * b) / a.scrollratio.y)),
        ...
        a.cursortimeout ||
          ...
          (a.cursortimeout = setTimeout(function () {
            (a.rail.active && a.showonmouseevent) ||
              ...
              a.zoom && a.zoom.stop().animate({ opacity: a.opt.cursoropacitymin }),
              (a.cursoractive = !1));
            a.cursortimeout = 0;
      ...
      this.onResize = function (b, c) {
        ...
        a.scrollvaluemax =
          a.view.h - a.cursorheight - a.cursor.hborder - (a.opt.railpadding.top + a.opt.railpadding.bottom);
        a.railh &&
          ((a.railh.width = 0 < a.page.maxh ? a.view.w - a.rail.width : a.view.w),
          (a.scrollvaluemaxw =
            a.railh.width - a.cursorwidth - a.cursorh.wborder - (a.opt.railpadding.left + a.opt.railpadding.right)));
      ...
      this.showRail = function () {
        0 == a.page.maxh ||
          ...
          ((a.visibility = !0), (a.rail.visibility = !0), a.rail.css('display', 'block'));
        return a;
      };
            ...
            (this.doScrollPos = function (b, c, d) {
              ...
              a.timer = setTimeout(function () {
                ...
                0 < k &&
                  ...
                  e.transitionend
                    ? a.scrollendtrapped ||
                      ((a.scrollendtrapped = !0), a.bind(a.doc, e.transitionend, a.onScrollTransitionEnd, !1))
          ...
          : ((this.doScrollLeft = function (b, c) {
            ...
            (this.doScrollPos = function (b, c, d) {
              ...
              0 == a.dst.x
                ...
                : 0 == a.dst.y && ((l = k), (n = b), (a.dst.ax = 1), (a.dst.px = 0));
              h = a.getTransitionSpeed(h);
              d && 1 >= d && (h *= d);
              a.bzscroll = 0 < h ? (a.bzscroll ? a.bzscroll.update(n, h) : new D(l, n, h, 0, 1, 0, 1)) : !1;
              if (!a.timer) {
                ((f == a.page.maxh && c >= a.page.maxh) || (k == a.page.maxw && b >= a.page.maxw)) &&
                  a.checkContentSize();
                var p = 1;
        ...
        if ((c.speedy && d && c.speedy) || f) {
          ...
          var p = c.lastscrollx,
            ...
            v = function () {
              ...
              c.speedx &&
                ((p = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy))), (c.lastscrollx = p), 0 > p || p > a) &&
                (d = 0.1);
              c.speedy &&
                ((e = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy))), (c.lastscrolly = e), 0 > e || e > t) &&
                (d = 0.1);
