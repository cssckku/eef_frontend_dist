    ...
    ut = (function () {
      ...
      return (
        ...
        (t._getItemIndex = function (t) {
          return (
            (this._items = t && t.parentNode ? [].slice.call(t.parentNode.querySelectorAll(ot)) : []),
              ...
              if (0 < i)
                for (var o = 0; o < i; o++) {
                  var r = this._triggerArray[o],
                    s = _.getSelectorFromElement(r);
                  if (null !== s)
                    g([].slice.call(document.querySelectorAll(s))).hasClass(yt) ||
      ...
      return (
        ...
        (c._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (t || ((t = new c(this, 'object' == typeof e ? e : null)), g(this).data(Nt, t)), 'string' == typeof e)
            ) {
      ...
      return (
        ...
        (t._fixTransition = function () {
          ...
          null === t.getAttribute('x-placement') &&
            (g(t).removeClass(qe), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = e));
        }),
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              ...
              (t || ((t = new i(this, e)), g(this).data(Ne, t)), 'string' == typeof n)
            ) {
              if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]();
            }
      ...
      return (
        ...
        (i._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (t || !/dispose|hide/.test(n)) &&
              (t || ((t = new i(this, e)), g(this).data(Ge, t)), 'string' == typeof n)
            ) {
              if ('undefined' == typeof t[n]) throw new TypeError('No method named "' + n + '"');
              t[n]();
            }
  ...
  var zn = 'toast',
    ...
    si = (function () {
      ...
      return (
        ...
        (t._getConfig = function (t) {
          return (
            (t = l({}, oi, {}, g(this._element).data(), {}, 'object' == typeof t && t ? t : {})),
